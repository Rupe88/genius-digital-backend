...
import { useReferralSharing } from '../ReferralProvider.jsx';
import { SocialSharing } from '../../referral-api.js';

/**
 * Share Button Component
 * Allows users to share courses and generate referral links
 */
export const ShareButton = ({
  ...
  const { generateSharingLinks, sharingData, loading, error, clearError } = useReferralSharing();
  ...
  const getModalClasses = () => {
    return `fixed inset-0 z-50 overflow-y-auto ${showModal ? 'block' : 'hidden'}`;
  };
                ...
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                    <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">
                      Share "{course?.title || 'this course'}"
                    </h3>

                    {/* Referral Stats */}
                    {showStats && sharingData && (
